...
/* install/step_3.twig */
class __TwigTemplate_67560046c2124b2564271e2e9bcdeb1f81db2ac428ab57f7f4acfdce4ccd2cbd extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col-sm-9\">
      <form action=\"";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["driver"]) {
            // line 34
            echo "                  ";
            if ((0 === twig_compare(($context["db_driver"] ?? null), twig_get_attribute($this->env, $this->source, $context["driver"], "value", [], "any", false, false, false, 34)))) {
                // line 35
                echo "                    <option value=\"";
